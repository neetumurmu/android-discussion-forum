...
public class VerifyRoll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLinkToLogin.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(VerifyRoll.this , LoginActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(VerifyRoll.this, RegisterActivity.class);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(VerifyRoll.this , LoginActivity.class);
        startActivity(i);
        finish();
        super.onBackPressed();
    }
